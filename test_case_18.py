...
def test_add_product_into_cart_success():
    ...
    back_to_homepage = driver.find_element(By.CSS_SELECTOR, "#back-to-products")
...
def test_remove_product_success():
    ...
    find_the_product_1 = driver.find_element(By.CSS_SELECTOR, "#item_4_img_link img")
    ...
    find_the_product_2 = driver.find_element(By.CSS_SELECTOR, "#item_1_img_link img")
