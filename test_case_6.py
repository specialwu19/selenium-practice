...
def test_browse_products_success():
    ...
    product_sort_button = driver.find_element(By.CSS_SELECTOR,"select.product_sort_container")
    product_sort_button.click()
    time.sleep(1)
    sort_atoz = driver.find_element(
        By.CSS_SELECTOR, "div.header_secondary_container select.product_sort_container option[value='az']"
    )
    sort_atoz.click()
